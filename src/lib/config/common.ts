import { type Icon, IconBrandGithub, IconMail } from "@tabler/icons-svelte";
...
const Site: Site = {
  ...
  description:
    "Dhananjay Singh Chauhan - Year 12 student specializing in cybersecurity, digital forensics, and blue team operations. NixOS user focused on secure systems and privacy.",
  tags: [
